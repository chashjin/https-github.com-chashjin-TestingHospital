    ...
    public partial class SendEmail : System.Web.UI.Page
    {
        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                if (!emailTo.Equals(""))
                {
                    MailMessage mm = new MailMessage(txtEmail.Text, txtTo.Text);                                //sender email, receiver
                    ...
                    smtp.EnableSsl = true;
                    NetworkCredential NetworkCred = new NetworkCredential(txtEmail.Text, txtPassword.Text);     //doctor email n password
