<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="RetrievePrescription.aspx.cs" Inherits="HMS.RetrievePrescription" %>
        ...
        <table style="width: 100%;">
            <tr>
                <td class="auto-style20">
                    <asp:Button ID="btnPrevious" runat="server" Text="Search for Previous Record" OnClick="btnPrevious_Click" Enabled="false" Width="230px"/> 
                </td>
                <td><asp:Button ID="btnToday" runat="server" Text="Search for Today Record" OnClick="btnToday_Click" Enabled="false" style="margin-left: 24px" /></td>
