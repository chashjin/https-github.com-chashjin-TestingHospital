<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MonthlyDispensedDrugsReport.aspx.cs" Inherits="HMS.Report1" %>
       ...
       <div class="auto-style1">
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td class="auto-style4">Monthly Dispensed Drugs Details Report for&nbsp;<asp:Label ID="lblLabel" runat="server" Text="[Label]"></asp:Label>
&nbsp;2015</td>
