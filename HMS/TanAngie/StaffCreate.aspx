<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="StaffCreate.aspx.cs" Inherits="StaffManagement.StaffCreate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="background">
        <div>
            <h1 style="color:darkblue">Staff Registration</h1>
        </div>
        <div>
            <table style="width:100%;">
                ...
                <tr>
                    <td class="auto-style1">Email Password :</td>
                    <td class="auto-style10">
                        <input id="pwEmail" type="password" runat="server"/></td>
                    <td><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="pwEmail" ErrorMessage="Please insert Email Password" ForeColor="Red" ValidationGroup="Submit">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style6">Department and Position</td>
                ...
                <tr>
                    ...
                    <td class="auto-style7">
                        <asp:TextBox ID="tbSalary" runat="server" Width="150px"></asp:TextBox>
                    </td>
                    <td>
